...
for (i in fnames) {
    ...
    #gather counts_df
    counts_df_long <- gather(counts_df, key=full_unwieldy, value=count, -depth)
    ...
    counts_df_long <- aggregate(count ~ depth + genus, data=counts_df_long, FUN="sum")
